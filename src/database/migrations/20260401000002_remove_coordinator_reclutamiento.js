...
exports.up = async function (knex) {
  ...
  await knex.raw(
    "ALTER TABLE users MODIFY COLUMN role ENUM('auditor_obama','auditor_claro','auditor_lv','auditor_reclutamiento','coordinator_obama','supervisor_calidad','gestor_usuarios') NOT NULL"
  );
};
